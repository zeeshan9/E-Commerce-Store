          ...
          <div class="col-sm-3 maxheight-div" >
            ...
            <div class="container-fluid">
                <div class="row" >
                  <div class="col-md-6" >
                  <?php
                    echo "<img src='../product_images/$img[2]' alt='Product Image' width='100%'>";  
                   ?>
                  </div>
                  <div class="col-md-6">
                  <?php
          ...
          <div class="col-md-9">
               ...
               <!-- Wrapper for slides -->
                    ...
                    <div class="item active">
                      <img src="../images/site_Images/bags_coraosal.webp" alt="Los Angeles" style="width:100%;">
                    ...
                    <div class="item">
                      <img src="../images/site_Images/bags_coraosal.webp" alt="Chicago" style="width:100%;">
                      <div class="carousel-caption">
                        <h3>Chicago</h3>
                    ...
                    <div class="item">
                      <img src="../images/site_Images/coroasal_2.webp"  alt="New York" style="width:100%;">
                      <div class="carousel-caption">
                        <h3>New York</h3>
        ...
        <div class="col-sm-2 pad">
              ...
              <div class="center- div" href="item_selected.php?id=". $id[$i]>
                  ...
                  <div class="hp-mod-price-second-line">
                     <span >Rs <?php echo $price[2]; ?> -40%</span> 
                  </div>
